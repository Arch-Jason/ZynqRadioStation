...
design_libs=(xilinx_vip xpm xbip_utils_v3_0_14 c_reg_fd_v12_0_10 xbip_dsp48_wrapper_v3_0_7 xbip_pipe_v3_0_10 c_addsub_v12_0_20 mult_gen_v12_0_23 axi_utils_v2_0_10 cordic_v6_0_24 xil_defaultlib)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../../../../../../opt/Xilinx/2025.1/data/rsb/busdef" +incdir+"/opt/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../opt/Xilinx/2025.1/data/rsb/busdef" +incdir+"/opt/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.cordic_0 xil_defaultlib.glbl -o cordic_0_simv
}
