...
HD_PWD='/home/jason/Documents/Zynq/radio/radio.runs/system_DAC_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_DAC_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_DAC_0_0.tcl
